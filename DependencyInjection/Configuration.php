...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode = $treeBuilder->root('sg_thrift');
        $rootNode
            ->children()
                ...
                ->arrayNode('services')
                    ...
                    ->prototype('array')
                        ->children()
                            ->scalarNode('idl')->isRequired()->end()
                            ->scalarNode('className')->defaultNull()->end()
                            ->scalarNode('namespace')->isRequired()->end()
                            ->scalarNode('path')->defaultNull()->end()
                            ->scalarNode('protocol')->defaultValue(TBinaryProtocolAccelerated::class)->end()
                            ->scalarNode('transport')->defaultValue(TBufferedTransport::class)->end()
